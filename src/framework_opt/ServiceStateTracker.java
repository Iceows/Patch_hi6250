...
public class ServiceStateTracker extends Handler {
    ...
    private long mSignalStrengthUpdatedTime = Long.MAX_VALUE;
    ...
    public void updatePhoneType() {
	 ...
	 if (DBG) log("Iceows updatePhoneType");
	...
	// init SignalStrength before create class ServiceState
    ...
    protected boolean notifySignalStrength() {
        ...
        if (!mSignalStrength.equals(mLastSignalStrength)) {
            try {
                ...
                if (DBG) log("Iceows notifySignalStrength");
        	...
        	if (DBG) log("Iceows notifySignalStrength not necessary");
        }
        return notified;
    }
    ...
    public SignalStrength getSignalStrength() {
    	...
    	// iceows
    	if (DBG) log("Iceows : SST.getSignalStrength().");
	...
	if (DBG) log("curTime :" + String.format("%d", curTime) + " mSignalStrengthUpdatedTime : " + String.format("%d", mSignalStrengthUpdatedTime));
        ...
        if (!ArrayUtils.isEmpty(subInfoList)) {
            if (DBG) log("Iceows : SST.shouldRefreshSignalStrength() subInfoList not empty");
            for (SubscriptionInfo info : subInfoList) {
                ...
                if (info.isOpportunistic()) {
                    ...
                    if (DBG) log("Iceows : SST.shouldRefreshSignalStrength() get getServiceState");
                    if (ss != null
                            && ss.getDataRegistrationState() == ServiceState.STATE_IN_SERVICE) {
                        if (DBG) log("Iceows : SST.shouldRefreshSignalStrength() return true");
                        return true;
                    }
                }
            }
	...
	{
		if (DBG) log("Iceows : SST.shouldRefreshSignalStrength() subInfoList empty");
	}
