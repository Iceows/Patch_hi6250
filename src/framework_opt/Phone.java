...
public abstract class Phone extends Handler implements PhoneInternalInterface {
    ...
    */
    ...
    public SignalStrength getSignalStrength() {
        ...
        if (sst == null) {
            Rlog.i(LOG_TAG, "Iceows : SignalStrength(phone) sst=null ");
            return new SignalStrength();
        } else {
            Rlog.i(LOG_TAG, "Iceows : SignalStrength(phone) sst=not null ");
    ...
    public void notifySignalStrength() {
    	Rlog.d(LOG_TAG, "Iceows notifySignalStrength (phone) ");
